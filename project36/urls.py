...
urlpatterns = [
    ...
    path('insertschooltempview/',insertschooltempview.as_view(),name='insertschooltempview'),

    path('insertschoolbyformview/',insertschoolbyformview.as_view(),name='insertschoolbyformview'),
]
